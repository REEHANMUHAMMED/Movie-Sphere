                    ...
                    <div className="flex items-center gap-3 xs:gap-4 sm:gap-6 ">
                      ...
                      <div className="relative ml-auto">
                        <button 
                          ...
                          className="text-gray-400 hover:text-white transition-colors duration-200 p-2 hover:bg-white/10 rounded-lg min-h-[44px] min-w-[44px] flex items-center justify-center cursor-pointer"
                        >
                          ...
                          <>
                            ...
                            >
                              <button
                                ...
                                className="w-full px-4 py-3 text-left text-red-400 hover:text-red-300 hover:bg-red-500/20 transition-all duration-200 text-sm font-medium min-h-[48px] touch-manipulation flex items-center gap-2 border-b border-white/10 cursor-pointer"
                              >
                                <span>🗑️</span>
                                Delete
                              </button>
                      ...
                      <div className="flex-1 flex flex-col xs:flex-row gap-2 xs:gap-3">
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="bg-red-600 hover:bg-red-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white px-3 xs:px-4 py-2 rounded-lg text-xs xs:text-sm transition-colors duration-200 whitespace-nowrap min-h-[44px] touch-manipulation  cursor-pointer"
                          >
                            Reply
                          </button>
                          <button
